...
///////////////////////////////////////////////
const int pinDir    = 3;  // pin for direction of rotation
const int pinStep   = 4;  // pin for stepping
...
void loop()
{
  ...
  else if (!singleShot)
  {
    ...
    makeStepperTurn(dir, 5*360.*nbStepPerRevol, stepAngle_deg, speedRPS, true);
    delay(1000);
  }
}
