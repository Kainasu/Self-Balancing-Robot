...
// Tuto calibration : https://42bots.com/tutorials/arduino-script-for-mpu-6050-auto-calibration/
...
void loop() {
    ...
    mpu.resetFIFO(); // TODOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
